...
$__System.register('5', ['3', '6', '7'], function (_export) {
    /** @jsx hJSX */
    ...
    var Observable, mvi, hJSX;

    _export('default', DynamicComponent);

    function DynamicComponent(sources) {
        var seconds$ = Observable.interval(1000).startWith(Math.ceil(Math.random() * 100)).scan(function (seconds) {
            return seconds + 1;
        });

        var vtree$ = seconds$.map(function (seconds) {
            return hJSX(
                'div',
                { className: 'whutt' },
                'I count ',
...
$__System.registerDynamic("2d", ["3", "f", "c", "1a", "24", "2a", "2e", "2c"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("2e", ["3", "28"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("42", ["3", "41", "2e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define,
      global = this,
...
$__System.registerDynamic("7", ["60"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.register('6', ['3', '7', '9'], function (_export) {
    ...
    var Rx, makeDOMDriver, run, mvi, getlinkCycleFn;
    return {
        setters: [function (_2) {
            Rx = _2;
        }, function (_3) {
        ...
        execute: function () {
            mvi = function mvi(_ref) {
                ...
                var v = !vtree ? view(model(intent)) : vtree,
                ...
                MAIN = function MAIN(sources) {
                    //const v = !vtree ? view(model(intent(sources[cycleKey]))) : vtree(sources[cycleKey]);
                    return linkCycle(v(sources[cycleKey]));
                },
...
$__System.register('61', ['3', '4', '5', '6', '7'], function (_export) {
    /** @jsx hJSX */
    'use strict';

    var Observable, combineLatestObj, DynamicComponent, mvi, makeDOMDriver, hJSX;

    _export('default', dynamic);

    function dynamic(_ref) {
        var el = _ref.el;

        function vtree(sources) {
            var componentVtrees$ = combineLatestObj({
                dynamicComponent1$: DynamicComponent(sources).DOM,
                dynamicComponent2$: DynamicComponent(sources).DOM
            });

            var vtree$ = componentVtrees$.map(function (vtrees) {
                return hJSX(
                    'div',
                    null,
    ...
    return {
        setters: [function (_2) {
            ...
            combineLatestObj = _3['default'];
        }, function (_4) {
            DynamicComponent = _4['default'];
        }, function (_5) {
            mvi = _5.mvi;
        }, function (_) {
            makeDOMDriver = _.makeDOMDriver;
            hJSX = _.hJSX;
        }],
        execute: function () {}
    };
});
$__System.register("1", ["61"], function (_export) {
