...
$__System.register('2', ['3', '4', '5', '6'], function (_export) {
    ...
    var mvi, Cycle, Rx, div, input, label, h2, makeDOMDriver, O;
    ...
    function slider(_ref) {
        ...
        return function (opt) {
            init = opt || init;
            var module = mvi({ intent: intent, model: model, view: view, render: render, el: el });

            function intent(source) {
                return module.source(source, 'input').map(function (ev) {
                    return parseInt(ev.target.value);
                });
            }

            function model(value$) {
                return O.combineLatest(value$.startWith(init.value || init.min || 0), function (value) {
                    return { value: value };
                });
            }
            ...
            function render(_ref2) {
                ...
                return div([label(title + ' ' + value + ' ' + unit), module.sink({ fn: input, opts: init })]);
            }
    ...
    return {
        setters: [function (_4) {
            ...
            label = _3.label;
            h2 = _3.h2;
            makeDOMDriver = _3.makeDOMDriver;
        }],
        execute: function () {
            O = Rx.Observable;
        }
...
$__System.register('7', ['2', '3', '4', '5', '6'], function (_export) {
    'use strict';

    var slider, mvi, Cycle, Rx, div, input, h2, makeDOMDriver, O;

    _export('default', calc);
    ...
    function init(_ref) {
        ...
        var weight$ = slider(sliders.sliderOne)();
        var height$ = slider(sliders.sliderTwo)();
    ...
    function calc(_ref2) {
        ...
        var sliders = _ref2.sliders;

        console.log("title is ... ", title);

        var _init = init({ el: el, title: title, sliders: sliders });

        var weight$ = _init.weight$;
        var height$ = _init.height$;

        function intent(DOMSource) {
            var changeWeight$ = weight$.intent(DOMSource);
            var changeHeight$ = height$.intent(DOMSource);
            return { changeWeight$: changeWeight$, changeHeight$: changeHeight$ };
        }

        function model(_ref3) {
            var changeWeight$ = _ref3.changeWeight$;
            var changeHeight$ = _ref3.changeHeight$;

            return O.combineLatest(weight$.model(changeWeight$), height$.model(changeHeight$), function (weight, height) {
                var heightMeters = height.value * 0.01;
                var bmi = Math.round(weight.value / (heightMeters * heightMeters));
                return { bmi: bmi, weight: weight, height: height };
            });
        }
        ...
        function render(_ref4) {
            ...
            return div([weight$.render(weight), height$.render(height), h2(title + bmi)]);
        }

        return mvi({ intent: intent, model: model, view: view, render: render, el: el });
    }
...
$__System.registerDynamic("4", ["9"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("b", ["d", "c", "a", "e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var h = $__require('c');
  var SVGAttributeNamespace = $__require('a');
  var attributeHook = $__require('e');
...
$__System.registerDynamic("f", ["5"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
...
$__System.registerDynamic("10", ["12", "11"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var isObject = $__require('12');
  var isHook = $__require('11');
...
$__System.registerDynamic("13", ["d", "14", "15", "16", "17", "18", "19", "10"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var isArray = $__require('d');
  var VPatch = $__require('14');
  var isVNode = $__require('15');
  var isVText = $__require('16');
  var isWidget = $__require('17');
  var isThunk = $__require('18');
  var handleThunk = $__require('19');
  var diffProps = $__require('10');
  module.exports = diff;
  function diff(a, b) {
    var patch = {a: a};
    walk(a, b, patch, 0);
...
$__System.registerDynamic("1a", ["13"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var diff = $__require('13');
  module.exports = diff;
  return module.exports;
});
...
$__System.registerDynamic("19", ["15", "16", "17", "18"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1c", ["1b", "1d", "15", "16", "17", "19"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var document = $__require('1b');
  var applyProperties = $__require('1d');
  var isVNode = $__require('15');
  var isVText = $__require('16');
  var isWidget = $__require('17');
  var handleThunk = $__require('19');
...
$__System.registerDynamic("12", ["1f"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("1d", ["12", "11"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("14", ["20"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var version = $__require('20');
  VirtualPatch.NONE = 0;
...
$__System.registerDynamic("21", ["17"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("22", ["1d", "17", "14", "21"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("23", ["1b", "d", "1c", "1e", "22"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var document = $__require('1b');
  var isArray = $__require('d');
  var render = $__require('1c');
  var domIndex = $__require('1e');
  var patchOp = $__require('22');
...
$__System.registerDynamic("27", ["28", "29", "25", "26"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var VNode = $__require('28');
  var VText = $__require('29');
  var domParser = new DOMParser();
  var propertyMap = $__require('25');
  var namespaceMap = $__require('26');
...
$__System.registerDynamic("2d", ["5", "f", "c", "1a", "24", "2a", "2e", "2c"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var Rx = $__require('5');
  var fromEvent = $__require('f');
  var VDOM = {
    h: $__require('c'),
    diff: $__require('1a'),
    patch: $__require('24'),
    parse: typeof window !== "undefined" ? $__require('2a') : function() {}
  };
  var _require = $__require('2e');
  var transposeVTree = _require.transposeVTree;
  var matchesSelector = undefined;
  try {
    matchesSelector = $__require('2c');
  } catch (err) {
...
$__System.registerDynamic("36", ["32", "33", "34", "35"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var lowerCase = $__require('32');
  var NON_WORD_REGEXP = $__require('33');
  var CAMEL_CASE_REGEXP = $__require('34');
  var TRAILING_DIGIT_REGEXP = $__require('35');
...
$__System.registerDynamic("3d", ["3b", "3c"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var escape = $__require('3b');
  var propConfig = $__require('3c');
...
$__System.registerDynamic("3f", ["3b", "30", "15", "16", "18", "17", "40", "e", "39", "3d", "3e"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  var escape = $__require('3b');
  var extend = $__require('30');
  var isVNode = $__require('15');
  var isVText = $__require('16');
  var isThunk = $__require('18');
  var isWidget = $__require('17');
  var softHook = $__require('40');
  var attrHook = $__require('e');
  var paramCase = $__require('39');
  var createAttribute = $__require('3d');
  var voidElements = $__require('3e');
...
$__System.registerDynamic("2e", ["5", "28"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
...
$__System.registerDynamic("42", ["5", "41", "2e"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
...
$__System.registerDynamic("43", ["44"], true, function($__require, exports, module) {
  ...
  (function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
      ...
      module.exports = factory(root, module.exports, $__require('44'));
    } else {
...
$__System.registerDynamic("45", ["44", "46"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("49", ["44"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("4c", ["44"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("4e", ["44"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("46", ["51"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("52", ["44"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("53", ["44", "43", "45", "47", "48", "49", "4a", "4b", "4c", "4d", "4e", "52"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("5", ["53"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("54", ["5"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
...
$__System.registerDynamic("d", ["55"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("28", ["20", "15", "17", "18", "11"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("15", ["20"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("5b", ["5a"], true, function($__require, exports, module) {
  ...
  var global = this;
  var GLOBAL = this;
  var OneVersionConstraint = $__require('5a');
  var MY_VERSION = '7';
...
$__System.registerDynamic("c", ["d", "28", "29", "15", "16", "17", "11", "18", "58", "40", "5d"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var isWidget = $__require('17');
  var isHook = $__require('11');
  var isVThunk = $__require('18');
  var parseTag = $__require('58');
  var softSetHook = $__require('40');
  var evHook = $__require('5d');
  module.exports = h;
...
$__System.registerDynamic("60", ["b", "2d", "42", "54", "c", "5f"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var _require2 = $__require('42');
  var makeHTMLDriver = _require2.makeHTMLDriver;
  var mockDOMSource = $__require('54');
  var h = $__require('c');
  var hh = $__require('5f')(h);
...
$__System.register('3', ['4', '5', '6'], function (_export) {
    ...
    var Cycle, Rx, makeDOMDriver, mvi, getlinkCycleFn;
    return {
        setters: [function (_) {
            Cycle = _['default'];
        }, function (_2) {
        ...
        execute: function () {
            mvi = function mvi(_ref) {
                var el = _ref.el;
                var intent = _ref.intent;
                var model = _ref.model;
                var view = _ref.view;
                var render = _ref.render;
                var makeDriver = _ref.makeDriver;
                var cycleKey = _ref.cycleKey;

                !makeDriver ? makeDriver = makeDOMDriver : "";
                !cycleKey ? cycleKey = el : "";
                var linkCycle = getlinkCycleFn(cycleKey),
                 ...
                 * @returns {*}
                 */
                source = function source(_source, evt) {
                    var src = _source.select(el);
                    if (evt) {
                ...
                drivers = function drivers() {
                    return linkCycle(makeDriver(el));
                },
                 ...
                 * @returns {{DOM: *}}
                 */
                main = function main(sources) {
                    return linkCycle(view(model(intent(sources[cycleKey]))));
                },
            ...
            getlinkCycleFn = function getlinkCycleFn(cycleKey) {
            ...
            _export('getlinkCycleFn', getlinkCycleFn);
        }
    };
});
$__System.register('1', ['3', '4', '7', '8'], function (_export) {
    ...
    var getlinkCycleFn, Cycle, calc, m1, m2, m3, m4, linkCycle;
    ...
    return {
        setters: [function (_4) {
            getlinkCycleFn = _4.getlinkCycleFn;
        }, function (_) {
            Cycle = _['default'];
        }, function (_2) {
            calc = _2['default'];
