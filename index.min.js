...
$__System.registerDynamic("4f", ["5a"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("5b", ["4d"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("5c", ["4d", "4c", "4e", "50", "51", "52", "53", "54", "55", "56", "57", "5b"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.registerDynamic("3", ["5c"], true, function($__require, exports, module) {
  ;
  var define,
      global = this,
      GLOBAL = this;
...
$__System.register('5d', ['3', '4', '4b'], function (_export) {
    'use strict';

    var Rx, Cycle, div, input, label, p, makeDOMDriver, O;
    ...
    function scroller(opt) {
        ...
        return function (opt2) {
            ...
            function intent(DOMBody) {
                ...
                return DOMBody.select("#" + opt.el).events('scroll').map(function (e) {
                    console.log("e is ... ", e);
                    return e.target.scrollTop;
                });
            }
            ...
            function view(scrollState$) {
                ...
                return scrollState$.map(function (state) {
                    ...
                    return div({ id: opt.el }, [div({ id: "screen" }, [p("scroll: " + state)])]);
                });
            }
...
$__System.register('1', ['5d'], function (_export) {
  'use strict';
