...
$__System.register('5d', ['3', '4', '5c'], function (_export) {
    ...
    return {
        ...
        execute: function () {
            _export('default', function (_ref) {
                ...
                var source = function source(_source, evt) {
...
$__System.register('5e', ['3', '4', '5c', '5d'], function (_export) {
    ...
    var Rx, Cycle, div, input, label, h2, mvi, O;
    ...
    function slider(_ref) {
        ...
        return function (opt) {
            ...
            function intent(DOMSource) {
                return module.source(DOMSource, 'input').map(function (ev) {
            ...
            function render(_ref2) {
                ...
                return div([div([label(title + ' ' + value + ' ' + unit), module.sink({ fn: input, opts: init })])]);
            }
...
$__System.register('5f', ['3', '4', '5c', '5d', '5e'], function (_export) {
    ...
    var Rx, Cycle, div, input, label, h2, makeDOMDriver, mvi, slider, O;

    _export('init', init);

    _export('default', bmiCalc);
    ...
    function bmiCalc(_ref) {
        ...
        return function () {
            ...
            function model(_ref2) {
                var changeWeight$ = _ref2.changeWeight$;
                var changeHeight$ = _ref2.changeHeight$;
            ...
            function view(state$) {
                return state$.map(function (_ref3) {
                    ...
                    return div([weight$.render(weight), height$.render(height), h2('bmi-calc: BMI is ' + bmi)]);
                });
            }

            var module = mvi({ intent: intent, model: model, view: view, el: el });
...
$__System.register('1', ['4', '5f'], function (_export) {
