...
$__System.registerDynamic("8", ["3f"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("45", ["44"], true, function($__require, exports, module) {
  ...
  var global = this;
  var GLOBAL = this;
  var OneVersionConstraint = $__require('44');
  var MY_VERSION = '7';
...
$__System.registerDynamic("7", ["8", "23", "24", "10", "11", "12", "c", "13", "42", "3b", "47"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var parseTag = $__require('42');
  var softSetHook = $__require('3b');
  var evHook = $__require('47');
  module.exports = h;
...
$__System.registerDynamic("4a", ["6", "28", "3d", "3e", "7", "49"], true, function($__require, exports, module) {
  "use strict";
  ;
  var define;
  var global = this;
  ...
  var mockDOMSource = $__require('3e');
  var h = $__require('7');
  var hh = $__require('49')(h);
...
$__System.registerDynamic("4c", ["4d"], true, function($__require, exports, module) {
  ...
  (function(factory) {
    ...
    if (typeof define === 'function' && define.amd) {
      ...
      module.exports = factory(root, module.exports, $__require('4d'));
    } else {
...
$__System.registerDynamic("52", ["4d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("55", ["4d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("56", ["4d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("57", ["4d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("58", ["4d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("59", ["4d", "4c", "4e", "50", "51", "52", "53", "54", "55", "56", "57", "58"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("3", ["59"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("4f", ["5c"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.registerDynamic("5d", ["3", "4f"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
  ...
  (function(process) {
    ...
    (function(factory) {
      ...
      if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(root, module.exports, $__require('3'));
      } else {
        root.Rx = factory(root, {}, root.Rx);
      }
    }.call(this, function(root, exp, Rx, undefined) {
      ...
      var FromEventObservable = (function(__super__) {
        ...
        FromEventObservable.prototype.subscribeCore = function(o) {
          return createEventListener(this._e, this._n, createHandler(o, this._fn), this._uc);
        };
      ...
      (function() {
        var events = 'blur focus focusin focusout load resize scroll unload click dblclick ' + 'mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave ' + 'change select submit keydown keypress keyup error contextmenu input';
...
$__System.registerDynamic("5e", ["3", "5d"], true, function($__require, exports, module) {
  ;
  var define;
  var global = this;
  var GLOBAL = this;
...
$__System.register('60', ['3', '5f'], function (_export) {
    'use strict';

    var Rx, RDOM;

    _export('default', scrollIntent);

    function scrollIntent(opt) {
        ...
        var scroll = source.subscribe(function (e) {
...
$__System.register('61', ['3', '4', '60', '4b', '5f'], function (_export) {
    'use strict';

    var Rx, Cycle, scrollIntent, div, input, label, p, img, makeDOMDriver, RDOM, O;
    ...
    function scroller(opt) {
        ...
        return function (opt2) {
            ...
            function intent(SOURCES) {
                ...
                return SOURCES.DOM.select("#" + opt.el).events('scroll').map(function (e) {
                    //console.log("e is ... ", e);
                    return e.target.scrollTop;
                });
            }
            ...
            function model(scrollAction$) {
                ...
                var scrollTop$ = scrollAction$.startWith(0);
                var state$ = O.combineLatest(scrollTop$, function (scrolltop) {
                    console.log("model: scrolltop is ... ", scrolltop);
                    return scrolltop;
                });
                return state$;
            ...
            ///// VIEW-TREE - render state - effector - rendering visual (sink) output for side-effects in the real world
            function view(scrollState$) {
                /////// ---> //// vTree output to DOM driver

                console.log("view: scrollState$ is ... ", scrollState$);

                return scrollState$.map(function (state) {
                    console.log("view: state is ... ", state);
                    //---> DIV has to match in selection with makeDOMDriver in the run Cycle
                    return div({
                        id: opt.el,
                        className: "hero-top"
                    }, [div({ id: "screen" }, [div({ id: "hero" }, [img({ uri: "" }), div({ id: "canvas" }), p("scroll: " + state)])])]);
                });
            }
    ...
    return {
        setters: [function (_2) {
            ...
            p = _b.p;
            img = _b.img;
            makeDOMDriver = _b.makeDOMDriver;
        }, function (_f) {
            RDOM = _f['default'];
        }],
        execute: function () {
